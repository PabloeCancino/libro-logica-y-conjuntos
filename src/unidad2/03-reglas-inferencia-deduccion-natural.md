...
### H. Ley de Conjunción (o Introducción del \\(\land\\))
...
### A. Ejemplificación Universal (E.U. o Eliminación de \\(\forall\\))
...
### B. Generalización Universal (G.U. o Introducción de \\(\forall\\))
...
### C. Ejemplificación Existencial (E.E. o Eliminación de \\(\exists\\))
...
### D. Generalización Existencial (G.E. o Introducción de \\(\exists\\))
