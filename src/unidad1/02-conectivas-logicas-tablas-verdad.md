...
### E. El Bicondicional (\\(\leftrightarrow\\))
...
### Ejemplo Completo de Evaluación: \\((p \to q) \land (q \to p) \leftrightarrow (p \leftrightarrow q)\\)

\\[
\begin{array}{|c|c|c|c|c|c|c|}
\hline
p & q & p \to q & q \to p & (p \to q) \land (q \to p) & p \leftrightarrow q & \text{Fórmula Final} \\
\hline
V & V & V & V & V & V & V \\
V & F & F & V & F & F & V \\
F & V & V & F & F & F & V \\
